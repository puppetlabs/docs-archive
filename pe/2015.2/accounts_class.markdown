---
layout: default
title: "PE 2015.2 » Accounts Module » The pe_accounts Class"
...
> **Note:** This class is assigned to the console's All Nodes group with no parameters, which will prevent it from being redeclared with any configuration. To use the class, you must:

* Unassign it from the All Nodes group in the console
