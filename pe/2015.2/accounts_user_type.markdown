---
layout: default
title: "PE 2015.2 » Accounts Module » The pe_accounts::user Type"
...
Many of the type's parameters echo those of the standard [`user` type](/references/4.2.latest/type.html#user).
