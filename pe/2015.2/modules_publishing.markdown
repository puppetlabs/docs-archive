...
canonical: "/puppet/4.2/reference/modules_publishing.html"
---
...
Follow the directions to [generate a new module](https://docs.puppetlabs.com/puppet/4.2/reference/modules_fundamentals.html#writing-modules).
...
~~~
    # puppet module build  /etc/puppetlabs/code/environments/production/modules/mymodule
    Building /etc/puppetlabs/code/environments/production/modules/mymodule for release
    /etc/puppetlabs/code/environments/production/modules/mymodule/pkg/examplecorp-mymodule-0.0.1.tar.gz
~~~
