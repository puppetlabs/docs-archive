---
layout: default
title: "PE 2015.2 » Orchestration » Invoking Actions"
...
Puppet Enterprise (PE) can invoke orchestration actions from the Linux command line on the Puppet master server.
...
You can use Puppet's [`ssh_authorized_key` resource type](/references/4.2.latest/type.html#sshauthorizedkey) to do this, or add keys manually to the `/var/lib/peadmin/.ssh/authorized_keys` file.
