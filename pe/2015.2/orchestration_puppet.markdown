---
layout: default
title: "PE 2015.2 » Orchestration » Controlling Puppet"
...
[tags]: /puppet/4.2/reference/lang_tags.html
...
The orchestration engine can control Puppet from the Puppet master server's Linux **command line.**
