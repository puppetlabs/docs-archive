---
layout: default
title: "PE 2015.2 » Quick Start » Module Installation (Windows)"
...
>
>**Note**: PE installs additional modules in `/opt/puppetlabs/puppet/modules`. These must not be modified, and you should not add your own modules to this directory, as they may be removed during upgrades.
