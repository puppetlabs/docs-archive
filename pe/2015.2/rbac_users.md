---
title: "PE 2015.2 » RBAC Service 1.0 >> User APIs"
layout: default
subtitle: "User Endpoints"
...
Web session authentication is required for this request.

**Accepts:** A JSON body containing entries for `email`, `display_name`,
`login`, `role_ids`, and `password`. The password field is optional. The created account will not be useful until the password is set.
