...
>**Note**: The following procedure is only compatible with PE 2015.3 or higher. If you're upgrading from an earlier version of PE, you can use these steps to re-configure your custom console cert.
...
3. Use the PE console to set the edit the parameters of the `puppet_enterprise::profile::console` class.
   ...
   h. Click __Add parameter__.

   i. Click the Commit change button.
