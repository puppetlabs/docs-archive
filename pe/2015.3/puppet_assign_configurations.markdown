---
layout: default
title: "Puppet: Assigning Configurations to Nodes"
...
[lang_params]: /puppet/4.3/reference/lang_classes.html#class-parameters-and-variables
[topscope]: /puppet/4.3/reference/lang_scope.html#top-scope
[node_definitions]: /puppet/4.3/reference/lang_node_definitions.html
[node_inheritance]: /puppet/4.3/reference/lang_node_definitions.html#inheritance
[resource_declarations]: /puppet/4.3/reference/lang_resources.html
[agent_cron]: ./puppet_overview.html#run-from-cron
[classes]: /puppet/4.3/reference/lang_classes.html
[include]: /puppet/4.3/reference/lang_classes.html#using-include
[resource_like]: /puppet/4.3/reference/lang_classes.html#using-resource-like-declarations
[hiera_params]: #assigning-class-parameters-with-hiera
[variable_assign]: /puppet/4.3/reference/lang_variables.html
[functions]: /puppet/4.3/reference/lang_functions.html
[selectors]: /puppet/4.3/reference/lang_conditional.html#selectors
[node_scope]: /puppet/4.3/reference/lang_scope.html#node-scope
[puppetdb_query]: https://forge.puppetlabs.com/dalen/puppetdbquery
[custom_functions]: /guides/custom_functions.html
[hash]: /puppet/4.3/reference/lang_datatypes.html#hashes
...
[import]: /puppet/4.3/reference/lang_import.html
[hiera_config]: /hiera/3.0/configuring.html
[hiera_hierarchies]: /hiera/3.0/hierarchy.html
[core_facts]: /facter/3.1/core_facts.html
[p3_special_vars]: /puppet/4.3/reference/lang_variables.html#facts-and-built-in-variables
[custom_facts]: /guides/custom_facts.html
[hiera_sources]: /hiera/3.0/data_sources.html
[hiera_cli]: /hiera/3.0/command_line.html
[hiera_classes]: /hiera/3.0/puppet.html#assigning-classes-to-nodes-with-hiera-hierainclude
[hiera_array]: /hiera/3.0/lookup_types.html#array-merge
[hiera_autoparams]: /hiera/3.0/puppet.html#automatic-parameter-lookup
[hiera_functions]: /hiera/3.0/puppet.html#hiera-lookup-functions
[dunn]: http://www.craigdunn.org/2012/05/239/
[include_like]: /puppet/4.3/reference/lang_classes.html#include-like-vs-resource-like
[hiera_priority]: /hiera/3.0/lookup_types.html#priority-default
[data_type]: /puppet/4.3/reference/lang_datatypes.html
[site_pp_vars]: #assigning-variables-with-sitepp
[hiera_arbitrary]: #providing-arbitrary-data
[exported]: /puppet/4.3/reference/lang_exported.html
...
[facts]: /puppet/4.3/reference/lang_variables.html#facts-and-built-in-variables
...
You can also read more about classes in [Puppet Modules and Manifests](TODO) and [Puppet Overview](./puppet_overview.html).
...
1. Choose a main data backend --- YAML or JSON --- and configure it in [the `:backends` setting](/hiera/3.0/configuring.html#backends).
2. Choose a data directory for your Hiera data source files, and configure it in [the `:datadir` sub-setting](/hiera/3.0/configuring.html#yaml-and-json) under the `yaml` or `json` settings:
