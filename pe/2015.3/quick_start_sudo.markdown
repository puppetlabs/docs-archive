...
The saz-sudo module contains several **classes**. [Classes](/puppet/4.3/reference/lang_classes.html) are named chunks of Puppet code and are the primary means by which Puppet Enterprise configures nodes.
