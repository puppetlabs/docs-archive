...
If you are upgrading to PE 2016.4 and have an unmodified `hiera.yaml` file, it is moved to the new location. If you've modified your `hiera.yaml`, you should move it to the new location, or future upgrades will fail.
