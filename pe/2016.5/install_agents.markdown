...
If your Puppet master and agent have the same OS and architecture, you can install your agents without any additional configuration on your Puppet master.  
