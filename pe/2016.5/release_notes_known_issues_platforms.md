...
## MCollective class filtering not functional on AIX agents

MCollective class filtering does not work on AIX agents. However, you can add a symlink on your AIX agents to enable class filtering. Perform this workaround as follows:

1. On your AIX agent, run the following commands:

~~~
mkdir -p /opt/freeware/var/lib/pe-puppet/
ln /opt/puppetlabs/puppet/cache/state/classes.txt /opt/freeware/var/lib/pe-puppet/classes.txt
~~~
