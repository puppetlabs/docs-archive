...
-   `puppetlabs.<MASTER-HOSTNAME>.http.puppet-v3-environments-requests`: The time spent handling requests to the [`environments` API endpoint]({{puppet}}/http_api/http_environments.html) requests made by the [Orchestrator](./orchestrator_intro.html)
