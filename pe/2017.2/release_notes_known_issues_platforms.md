...
Puppet agents running RHEL 7 or Ubuntu 16.04 on IBM POWER8 hardware do not use Ruby gems correctly, preventing the MCollective service from starting. This issue will be resolved in an upcoming release. <!--PE-21713--> 
