...
|`leaf_groups`|Corresponds to step 2 of classification, finding the leaves. This key's value is an array of the leaf groups \(i.e., those groups that are not related to any of the other matching groups\).|
