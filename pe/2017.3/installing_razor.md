...
**Note:** Don’t install the Puppet Enterprise Razor client, `pe-razor-client`, alongside the open source Razor client, `razor-client`. If you already have `razor-client` installed, or are not sure if you do, run `gem uninstall razor-client` before installing the Puppet Enterprise client.
...
1.  Install the client: `gem install pe-razor-client`
    ...
    **Tip:** If you're installing the Razor client on your master, you must specify the location of the gem: `**/opt/puppetlabs/puppet/bin/gem install pe-razor-client**`
