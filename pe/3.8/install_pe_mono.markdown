...
5. Select whether or not to enable the Puppet 4 language parser.
   ...
   The Puppet 4 language parser (i.e., the future parser) gives you valuable language features, makes debugging easier, and will help keep your Puppet code compatible with future releases in the next major series. Recommended for all **NEW** Puppet users.
