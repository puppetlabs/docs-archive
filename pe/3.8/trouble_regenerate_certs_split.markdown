---
layout: default
title: "PE 3.8 » Security and SSL » Cert Regeneration: Split Deployments"
...
12. Copy the Diffie-Hellman (DH) param files into place.
...
13. Ensure the console can access the new credentials.
...
Kick off a Puppet run. A successful Puppet run on the master, PuppetDB and PE console is necessary to ensure that the PE orchestration service and ActiveMQ is configured properly.
