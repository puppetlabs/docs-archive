...
* [Pipelines Application](https://puppet.com/docs/pipelines-for-apps/free/application-create.html)
...
For more info, see Pipelines for Applications [Environment Settings](https://puppet.com/docs/pipelines-for-apps/free/environment.html).
